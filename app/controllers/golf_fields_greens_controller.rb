class GolfFieldsGreensController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @golf_fields_green.save
        format.html { redirect_to @golf_fields_green, notice: 'Golf fields green was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @golf_fields_green.update_attributes(params[:golf_fields_green])
        format.html { redirect_to @golf_fields_green, notice: 'Golf fields green was successfully updated.' }
        format.json { head :ok }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to golf_fields_greens_url }
      format.json { head :ok }
    end
  end
end
